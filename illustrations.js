function getBirdSVG(id, artBg) {
  ...
  const svgs = {
    ...
    // 31 Wren
    31: `<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
      <rect width="200" height="160" fill="${bg}"/>
    ...
    // 32 Jackdaw
    32: `<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
      <rect width="200" height="160" fill="${bg}"/>
      <ellipse cx="100" cy="152" rx="50" ry="6" fill="#00000018"/>
    ...
    // 33 Coal Tit
    33: `<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
      <rect width="200" height="160" fill="${bg}"/>
    ...
    // 34 Swallow
    34: `<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
      <rect width="200" height="160" fill="${bg}"/>
      <ellipse cx="97" cy="148" rx="45" ry="5" fill="#00000018"/>
      <rect x="58" y="118" width="78" height="9" rx="4" fill="#224488"/>
      <ellipse cx="143" cy="120" rx="20" ry="5" fill="#224488" transform="rotate(-25,143,120)"/>
    ...
    // 35 Red Kite
    35: `<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
      <rect width="200" height="160" fill="${bg}"/>
      ...
      <ellipse cx="100" cy="118" rx="8" ry="20" fill="#cc5522"/>
      <ellipse cx="93" cy="130" rx="6" ry="11" fill="#aa3311" transform="rotate(-10,93,130)"/>
      <ellipse cx="107" cy="130" rx="6" ry="11" fill="#aa3311" transform="rotate(10,107,130)"/>
    ...
    // 36 Buzzard
    36: `<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
      <rect width="200" height="160" fill="${bg}"/>
    ...
    // 37 Mute Swan
    37: `<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
      <rect width="200" height="160" fill="${bg}"/>
    ...
    // 38 Cormorant
    38: `<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
      <rect width="200" height="160" fill="${bg}"/>
    ...
    // 39 Merlin
    39: `<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
      <rect width="200" height="160" fill="${bg}"/>
      <ellipse cx="100" cy="152" rx="52" ry="6" fill="#00000018"/>
